...
<!-- Mirrored from wrappixel.com/demos/admin-templates/material-pro/material/pages-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Feb 2018 09:57:29 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>World Bank - Register </title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="login-register" >        
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="register" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" required="" placeholder="Mobile" name="mobile">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">

...
<%@ page import="java.util.ArrayList,com.bank.dto.TransactionDTO"%>
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><%=transactionDTO.getTransactionId() %></td>
                                                <td><%=transactionDTO.getDate() %></td>
                                                <td><%if(transactionDTO.getTranscationType().equalsIgnoreCase("credited")) {%>
                                                		Rs. <%= transactionDTO.getTranscactionAmount()%>
                                                	 <%} %>
                                                </td>
                                                
                                                <td><%if(transactionDTO.getTranscationType().equalsIgnoreCase("debited")) {%>
                                                		Rs. <%= transactionDTO.getTranscactionAmount()%>
                                                	 <%} %>
                                                </td>
                                                <td>Rs.<%=transactionDTO.getBalance() %></td>
                                            </tr>
                                            <%} %>
                                        </tbody>
                                    </table>
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer"> © 2018 Mccoy Global Links </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>

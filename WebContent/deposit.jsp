    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="login-box card" style="margin-left: 10px;">
                <div class="card-body">
                  <form class="form-horizontal form-material" id="loginform" action="deposit" method="post">
                    ...
                    <div class="form-group text-center">
                      <div class="col-xs-12">
                        <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Deposit</button>
                      </div>
                    </div>
                  </form>
                </div>
